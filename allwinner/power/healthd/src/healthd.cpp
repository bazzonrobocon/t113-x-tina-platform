...
extern void healthd_mode_tina_battery_update(struct BatteryProperties *props, char *node);
...
extern void healthd_mode_charger_battery_update(struct BatteryProperties *props, char *node);

/* NOPs for modes that need no special action */
static void healthd_mode_nop_init(struct healthd_config *config);
static int healthd_mode_nop_preparetowait(void);
static void healthd_mode_nop_heartbeat(void);
static void healthd_mode_nop_battery_update(struct BatteryProperties *props, char *node);
