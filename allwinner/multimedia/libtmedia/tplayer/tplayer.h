...
typedef enum TplayerNotifyAppType
{
    ...
    TPLAYER_NOTIFY_DISP_RECT_SET_ERROR     = 19,
    TPLAYER_NOTIFY_ODD_EVEN_COORDINATE_SET_ERROR = 20,
    TPLAYER_NOTIFY_WIDTH_AREA_SET_ERROR = 21,
    TPLAYER_NOTIFY_DISP_DISLOCATION_ERROR = 22,
