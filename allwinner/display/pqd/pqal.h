...
struct pqal {
     ...
     */
    int (*get_hardware_info)(int* id, int* version, int* gamma_bitwidth);
    ...
    /* dci */
    int (*set_dci)(const char* data, int size);
    int (*get_dci)(char* data, int size);
    /* deband */
    int (*set_deband)(const char* data, int size);
    int (*get_deband)(char* data, int size);
    /* snr */
    int (*set_snr)(const char* data, int size);
    int (*get_snr)(char* data, int size);
    /* gtm */
    int (*set_gtm)(const char* data, int size);
    int (*get_gtm)(char* data, int size);
    /* tnr */
    int (*set_tnr)(const char* data, int size);
    int (*get_tnr)(char* data, int size);
};
...
struct hardware_data {
    ...
    int gamma_bitwidth; /* DE gamma_tbl bit width, e.g. 8 */
    struct pqal* apis;
};
