...
status_t parseProgramMap(Program *program, CdxBitReaderT *br)
{
   ...
   */
    ...
    //if program_info_length is abnormal, skip it
    if(program_info_length > section_length - 9 -4)
    {
        logw("the program_info_length is wrong!");
        program_info_length = section_length - 9 - 4;
    }
